...
git clone --recursive https://github.com/intel-innersource/firmware.security.tdx.vtpm.td.git vtpm-td
git clone --recursive https://github.com/intel-innersource/firmware.security.tdx.vtpm.tdvf.git vtpm-tdvf
